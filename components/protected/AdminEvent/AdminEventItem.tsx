...
const AdminEventItem = (props:{title? :string ,description?:string, date ?: Date , _id ?:string,onClickEdit?:Function, onClickDelete? : Function}) => {
    ...
    const handleEditItem = (data)=>{
        return props.onClickEdit(props._id,data)
    }

    return (
        <div className="eventitem eventpage">
            <ModalOverlay onClose={()=>setEdit(!edit)} title="Edit Event" active={edit}>
                <AdminEventForm onSubmit={handleEditItem} edit={true} title={props.title} date={props.date} description={props.description} handleClose={handleEditItem}/>
            </ModalOverlay>
