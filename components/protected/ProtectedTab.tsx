        ...
        <div  className="adminheadermenu">
                    <div className="adminheader">
                        ...
                        <a  onClick={()=>{
                         ...
                         <a onClick={()=>{
                            router.push('/protected/MaterialsAdmin' ,null, { shallow: true })
                        }} className={ router.pathname=== "/protected/MaterialsAdmin" ? "adminhederitem active w--current"  :" adminhederitem"}>Material</a>
                        <a onClick={()=>{
